...
const start = async () => {
    ...
    // use crummy async middleware to pass build stats.
    clientPromise.then((clientStats) => {
        // yeah, really, really crummy
        fs.writeFile(paths.serverBuild + '/manifest.json', JSON.stringify(clientStats), 'utf8');
    });
